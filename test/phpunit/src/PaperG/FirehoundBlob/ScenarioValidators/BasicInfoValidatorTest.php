...
use PaperG\FirehoundBlob\ScenarioValidators\BasicInfoValidator;
...
class BasicInfoValidatorTest extends \PHPUnit_Framework_TestCase
{
    ...
    public function test_isValidCreateBlob_WithValidBlobAndIsCreateRequest_ReturnsTrue()
    {
        ...
        $mockBasicInfo    = $this->getMockBuilder('\PaperG\FirehoundBlob\BasicInfo')->disableOriginalConstructor()->getMock();
